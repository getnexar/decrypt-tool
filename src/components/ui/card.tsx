...
function CardClose({ className, onClick, ...props }: React.ComponentProps<"button">) {
  return (
    <Button
      data-slot="card-close"
      type="button"
      variant="outline"
      size="icon-default-round"
      onClick={onClick}
      className={cn(
        "absolute top-6 right-6 size-10",
        className
      )}
      {...props}
    >
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-muted-foreground text-sm max-w-[calc(100%-4rem)]", className)}
      {...props}
    />
  )
}
